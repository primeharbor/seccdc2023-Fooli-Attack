...
def main(args):
    ...
    payload = {
        ...
        "expires": time.time() + float(args.jwt_expires)
    }
    token = jwt.encode(payload, args.jwt_secret, algorithm=args.jwt_algorithm)
...
def do_args():
    ...
    parser.add_argument("--username", help="Username to forge token for", default="hacker")
